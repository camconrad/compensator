        ...
        {authorized ? (
          ...
          >
            <motion.div className="mb-2" variants={itemVariants}>
              ...
              <h1 className="mt-1 text-3xl font-bold tracking-tight text-[#030303] dark:text-white">
                Compensator
              </h1>
              <p className="text-gray-600 dark:text-gray-400 mt-[2px] mb-1">
            ...
            <motion.div className="rounded-xl w-full" variants={itemVariants}>
              <form
                ...
                className="flex flex-col gap-3 max-w-[360px] mx-auto w-full"
              >
            ...
            <motion.div
              className="flex flex-col gap-2 mt-4 text-xs text-gray-500 dark:text-gray-400 max-w-xs"
              variants={itemVariants}
            >
              <p>
