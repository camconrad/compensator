  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#EFF2F5] dark:bg-[#0D131A]">
          ...
          <motion.div className="w-full max-w-[360px]" variants={itemVariants}>
            ...
            >
              ...
              <motion.button
                ...
                } bg-emerald-500 text-white py-3 min-h-[50px] font-sans px-6 rounded-full font-medium transition-colors flex justify-center items-center`}
                disabled={loading}
        ...
        {/* Footer Section */}
        <motion.footer
          className="mt-[64px] font-sans pb-4 flex gap-2 flex-wrap items-center justify-center text-[13px] text-gray-500 dark:text-gray-400"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
